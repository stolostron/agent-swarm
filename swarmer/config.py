...
class Settings(BaseSettings):
    ...
    gemini_preset_plan_model: str = "google/gemini-3.7-flash@default"
    gemini_preset_build_model: str = "google/gemini-3.7-flash@default"
    gemini_preset_small_model: str = "google/gemini-3.5-flash-lite@default"
