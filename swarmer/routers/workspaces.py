...
async def workspace_create(
    ...
    gateway_client_secret: str = Form(""),
    gateway_service_account_subject: str = Form(""),
    ...
    if gateway_mode == "custom" and gateway_url.strip():
        gateway_payload = {
            ...
            "client_secret": gateway_client_secret.strip() or None,
            "service_account_subject": gateway_service_account_subject.strip() or None,
