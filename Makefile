...
api-info:  ## Display Swarmer API URL and opencode.json snippet
	@python3 scripts/mcp_setup.py --print-only --namespace "$(NAMESPACE)"

mcp-setup:  ## Configure opencode.json for Agent Swarm
	@python3 scripts/mcp_setup.py --namespace "$(NAMESPACE)"
